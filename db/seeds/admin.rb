model = Administrator.where(email: 'jrhorn424@gmail.com').first_or_create
...
model.skip_confirmation!
model.save(:validate => false)
model = Administrator.where(email: 'daniel.houser@gmail.com').first_or_create
...
model.skip_confirmation!
model.save(:validate => false)
model = Administrator.where(email: 'sychoi').first_or_create
model.update_attributes({email: 'sychoi', id: 1361455093, last_name: "Manager", first_name: "Ices", type: 'Administrator'})
model.skip_confirmation!
model.save(:validate => false)
model = Administrator.where(email: 'mfreer@masonlive.gmu.edu').first_or_create
...
model.skip_confirmation!
model.save(:validate => false)
model = Administrator.where(email: 'edemiral@masonlive.gmu.edu').first_or_create
...
model.skip_confirmation!
model.save(:validate => false)
model = Administrator.where(email: 'ychao3@masonlive.gmu.edu').first_or_create
...
model.skip_confirmation!
model.save(:validate => false)
model = Administrator.where(email: 'adexterr@masonlive.gmu.edu').first_or_create
...
model.skip_confirmation!
model.save(:validate => false)
model = Administrator.where(email: 'dkling2@gmu.edu').first_or_create
model.update_attributes({email: 'dkling2@gmu.edu', id: 1378585169, last_name: "Kling", first_name: "Daniel", type: 'Administrator'})
model.skip_confirmation!
model.save(:validate => false)
model = Administrator.where(email: 'dmarti23@masonlive.gmu.edu').first_or_create
...
model.skip_confirmation!
model.save(:validate => false)
model = Administrator.where(email: 'ppodolsky@me.com').first_or_create
model.update_attributes({email: 'ppodolsky@me.com', id: 1393610059, last_name: "Podolsky", first_name: "Pavel", type: 'Administrator'})
model.skip_confirmation!
model.save(:validate => false)
model = Administrator.where(email: 'dchavann@conncoll.edu').first_or_create
